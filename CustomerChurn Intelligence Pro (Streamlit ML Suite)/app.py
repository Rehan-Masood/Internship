...
st.caption(
    'Enterprise Machine Learning Engine for Predictive Analytics & Customer Retention'
)
st.markdown('---')
...
# --- TAB 2: LIVE CHURN PREDICTOR ---
  ...
  with res_col2:
    if prob >= 65:
      ...
      st.warning(
          '⚠️ **MEDIUM RISK:** Customer showing warning signs. Monitor tickets'
          ' and engagement.'
      )
    else:
      st.success(
          '✅ **LOW RISK:** Account in good standing with low probability of'
          ' leaving.'
      )
